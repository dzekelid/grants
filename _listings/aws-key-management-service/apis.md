...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/grants/master/_listings/aws-key-management-service/apis.md
...
- name: AWS Key Management Service API - Create Grant
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/grants/master/_listings/aws-key-management-service/actioncreategrant-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/grants/master/_listings/aws-key-management-service/actioncreategrant-get-openapi.md
- name: AWS Key Management Service API - List Grants
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/grants/master/_listings/aws-key-management-service/actionlistgrants-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/grants/master/_listings/aws-key-management-service/actionlistgrants-get-openapi.md
- name: AWS Key Management Service API - List Retirable Grants
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/grants/master/_listings/aws-key-management-service/actionlistretirablegrants-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/grants/master/_listings/aws-key-management-service/actionlistretirablegrants-get-openapi.md
- name: AWS Key Management Service API - Retire Grant
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/grants/master/_listings/aws-key-management-service/actionretiregrant-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/grants/master/_listings/aws-key-management-service/actionretiregrant-get-openapi.md
- name: AWS Key Management Service API - Revoke Grant
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/grants/master/_listings/aws-key-management-service/actionrevokegrant-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/grants/master/_listings/aws-key-management-service/actionrevokegrant-get-openapi.md
- name: AWS Key Management Service API - Create Grant
  x-api-slug: actioncreategrant-get
  description: Adds a grant to a key to specify who can use the key and under what
    conditions.
